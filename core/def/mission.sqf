...
btc_version = 1.16; diag_log format ["Butts and Limes %1",(str(btc_version) + ".1")];
...
if (isServer) then {
	...
	btc_helo = [btc_helo_1,btc_boat_1,btc_boat_2];
};
...
btc_fnc_log_get_towable = {
	...
	switch (true) do {
		...
		case (_tower isKindOf "Truck_F") : {_array = ["Car","Truck","Truck_F","Wheeled_APC","Tracked_APC","Tank"];};
		case (_tower isKindOf "Tracked_APC") : {_array = ["Car","Truck","Truck_F","Wheeled_APC","Tracked_APC","Tank"];};
		case (_tower isKindOf "Tank") : {_array = ["Car","Truck","Truck_F","Wheeled_APC","Tracked_APC","Tank"];};
...
btc_fnc_log_get_liftable = {
	...
	switch (typeOf _chopper) do	{
		//MH9
		case "RHS_MELB_AH6M_L"     : {_array = ["Motorcycle","ReammoBox","ReammoBox_F","Quadbike_01_base_F","Strategic"];};
		//PO-30
		case "O_Heli_Light_02_F"     : {_array = ["Motorcycle","ReammoBox","ReammoBox_F","StaticWeapon","Car"];};

		case "RHS_UH60M" : {_array = (["Motorcycle","ReammoBox","ReammoBox_F","StaticWeapon","Car","Truck","Wheeled_APC"]) + ((btc_construction_array select 1) select 3) + ((btc_construction_array select 1) select 4) + ((btc_construction_array select 1) select 5);};
...
switch (true) do {
	...
	case (_p_en == 2) :
	{
		...
		btc_type_units		= ["I_Soldier_F","I_Soldier_TL_F","I_Soldier_AR_F","I_engineer_F","I_Soldier_exp_F","I_Soldier_GL_F","I_Soldier_LAT_F","I_Soldier_AT_F","I_Spotter_F","I_Sniper_F","I_Soldier_LAT_F"];
